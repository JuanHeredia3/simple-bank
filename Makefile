...
.PHONY: postgres createdb dropdb migrateup migratedown sqlc test server mockdb migrateup1 migratedown1 db_docs db_schema proto evans redis new_migration