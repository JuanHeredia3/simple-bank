...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\x1a\x14rpc_login_user.proto\x1a\x15rpc_create_user.proto\x1a\x16rpc_verify_email.proto\x1a\x15rpc_update_user.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\xed\x02\n" +
	"\n" +
	"SimpleBank\x12W\n" +
	"\n" +
	...
	"\vVerifyEmail\x12\x16.pb.VerifyEmailRequest\x1a\x17.pb.VerifyEmailResponse\"\x18\x82\xd3\xe4\x93\x02\x12\x12\x10/v1/verify_emailB\x9d\x01\x92Ar\x12p\n" +
	"\x0fSimple Bank API\"X\n" +
	"\x14gRPC-Gateway project\x12.https://github.com/grpc-ecosystem/grpc-gateway\x1a\x10none@example.com2\x031.1Z&github.com/JuanHeredia3/simple-bank/pbb\x06proto3"
